...
export const productRouter = (controller: ProductController) => {
   ...
   *               $ref: '#/components/schemas/Error'
   */
  router.get("/categorys", controller.getProductsCategory);
   ...
   *               $ref: '#/components/schemas/Error'
   */
  router.delete("/category/:cid", controller.deleteCategory);
   ...
   *               $ref: '#/components/schemas/Error'
   */
  router.post("/categorys", controller.createCategory);
