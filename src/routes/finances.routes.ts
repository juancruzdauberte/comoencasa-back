...
export const financeRouter = (controller: FinanceController) => {
  const router = Router();
  /**
   * @swagger
   * /api/finances/today:
   ...
   */
  router.get("/today", controller.getAmountToday);
   ...
   *               $ref: '#/components/schemas/FinanceAmount'
   */
  router.get("/today/transfer", controller.getTransferAmountToday);
   ...
   *               $ref: '#/components/schemas/FinanceAmount'
   */
  router.get("/today/cash", controller.getCashAmountToday);
   ...
   *               $ref: '#/components/schemas/FinanceAmount'
   */
  router.get("/today/delivery/pay", controller.getDeliveryAmountToPay);
   ...
   *               $ref: '#/components/schemas/FinanceAmount'
   */
  router.get("/today/delivery/cash", controller.getDeliveryCashAmount);
   ...
   */
  router.get("/param", controller.getValueFinanceParam);
   ...
   */
  router.put("/param", controller.updateValueFinanceParam);
   ...
   *               $ref: '#/components/schemas/FinanceAmount'
   */
  router.get("/monthly", controller.getAmountMonthly);
   ...
   *               $ref: '#/components/schemas/FinanceAmount'
   */
  router.get("/monthly/cash", controller.getCashAmountMonthly);
   ...
   *               $ref: '#/components/schemas/FinanceAmount'
   */
  router.get("/monthly/transfer", controller.getTransferAmountMonthly);
  return router;
};
